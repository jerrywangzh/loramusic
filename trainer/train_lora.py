...
if __name__ == "__main__":
    ...
    parser.add_argument("--data_path", type=str, default="../dataset/lora_music.jsonl")
    parser.add_argument("--lora_name", type=str, default="lora_music", help="根据任务保存成lora_(英文/医学/心理...)")
